...
import InstructorDashboard from "./BaseFiles/InstructorDashboard";
function App() {
  return (
    <Router>
    <ScrollToTop>
      <Routes>
        <Route element={<PrivateRoute />}>
          <Route element={<DashboardLayout />}>
            ...
            <Route path="/admin/courses/view/:id" element={<CoursePreview />} />
          ...
          <Route path="/dashboard/instructor" element={<h1>Hello Instructor</h1>} />
          </Route>
        </Route>
