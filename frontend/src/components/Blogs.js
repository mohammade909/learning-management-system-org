...
export default function Blogs() {
  return (
    ...
    //       </p>
    //     </div>
    //     <div className="mx-auto mt-5 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-5 sm:pt-10 lg:mx-0 lg:max-w-none lg:grid-cols-3">
    //       {posts.map((post) => (
    //         <article
    //           key={post.id}
          ...
          <div className="rounded overflow-hidden shadow-lg flex flex-col">
            ...
            <div className="relative">
              <a href="#">
                <img
                  className="w-full"
                  src="https://cdn.corporatefinanceinstitute.com/assets/marketing.jpeg"
            ...
            <div className="px-6 py-4 mb-auto">
              ...
              Access the secrets to successful marketing. Learn new ways to grow your business and connect with your audience better.
          ...
          <div className="rounded overflow-hidden shadow-lg flex flex-col">
            ...
            <div className="relative">
              <a href="#">
                <img
                  className="w-full"
                  src="https://segwitz.com/wp-content/uploads/2023/09/5757453-scaled-1.jpg"
                  alt="Sunset in the mountains"
                />
                <div className="hover:bg-transparent transition duration-300 absolute bottom-0 top-0 right-0 left-0 bg-gray-900 opacity-25"></div>
              </a>
            ...
            <div className="px-6 py-4 mb-auto">
              ...
              <p className="text-gray-500 text-sm">
              Investigate the process of creating intuitive and visually appealing designs. Learn how to improve the user experience and streamline interfaces for better usability.
              </p>
            </div>
            <div className="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
              <span
          ...
          <div className="rounded overflow-hidden shadow-lg flex flex-col">
            ...
            <div className="relative">
              <a href="#">
                <img
                  className="w-full"
                  src="https://oilab.in/public/img/courses/full-stack-web-developer.jpg"
                  alt="Sunset in the mountains"
                />
                <div className="hover:bg-transparent transition duration-300 absolute bottom-0 top-0 right-0 left-0 bg-gray-900 opacity-25"></div>
              </a>
            ...
            <div className="px-6 py-4 mb-auto">
              ...
              <p className="text-gray-500 text-sm">
              Learn about the world of FullStack Development with our comprehensive guides. To create robust applications, you must understand both front-end and back-end technologies.
